...
public class HostAppNoGUI
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			settings = new SystemFileReader("/mnt/BackupDrive/HostSettings.txt");
		}
		...
		{
			System.out.println(
					"Settings file must include a default location in format \"Storage Location:> location to use:>\"");
			System.exit(2);
		}
		...
		new Thread(()->
		{
			...
			while(!close)
			{
				...
				try
				{
					...
					System.out.println("Got packet: " + got);
